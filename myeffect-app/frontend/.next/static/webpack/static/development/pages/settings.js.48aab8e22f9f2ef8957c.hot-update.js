...
})(["background:#fff;height:30px;border-radius:12px 12px 0px 0px;font-size:12px;input:active,input:focus{color:", ";box-shadow:", ";}"], function (props) {
...
})(["height:30px;font-size:17px;line-height:30px;text-align:center;color:black;input:active,input:focus{box-shadow:", ";}"], function (props) {
  return props.theme.bsblack;
});
...
//# sourceMappingURL=settings.js.48aab8e22f9f2ef8957c.hot-update.js.map