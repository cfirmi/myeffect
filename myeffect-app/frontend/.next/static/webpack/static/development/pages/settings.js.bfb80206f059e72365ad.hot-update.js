...
})(["background:red;display:grid;grid-template-columns:repeat(7,1fr);grid-gap:0px 10px;min-width:800px;margin-left:50%;transform:translateX(-50%);text-align:center;justify-content:space-around;a{color:white;}"]);
...
})(["border:2px solid black;width:100%;height:40px;border-radius:10px 5px 3px 20px;"]);
...
//# sourceMappingURL=settings.js.bfb80206f059e72365ad.hot-update.js.map