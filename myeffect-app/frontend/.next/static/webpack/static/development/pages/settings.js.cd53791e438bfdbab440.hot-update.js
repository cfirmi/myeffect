...
})(["background:red;display:grid;grid-template-columns:repeat(7,1fr);grid-gap:0px 40px;min-width:1000px;margin-left:50%;transform:translateX(-50%);text-align:center;justify-content:space-around;a{background:#000;width:100%;color:white;}"]);
...
})(["border:2px solid black;width:100%;height:40px;font-size:17px;line-height:10px;border-radius:10px 10px 0px 0px;padding:0px 10px;input:active,input:focus{box-shadow:", ";}"], function (props) {
...
//# sourceMappingURL=settings.js.cd53791e438bfdbab440.hot-update.js.map