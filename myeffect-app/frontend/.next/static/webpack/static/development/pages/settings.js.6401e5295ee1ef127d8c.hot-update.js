...
})(["background:green;width:100%;a{}"]);
var Innerbox = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "links2__Innerbox",
  componentId: "sc-1qygtkp-1"
})(["display:grid;grid-template-columns:repeat(7,1fr);grid-gap:20px;"]);
...
})(["border:2px solid white;background:#000;line-height:40px;"]);
var Title = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "links2__Title",
  componentId: "sc-1qygtkp-3"
})(["height:40px;font-size:17px;line-height:20px;input:active,input:focus{box-shadow:", ";}"], function (props) {
...
function (_Component) {
  ...
  _createClass(links, [{
    key: "calcNavWidth",
    value: function calcNavWidth() {
      var navword = this.state.navItems.name;
      var px = navword.length + 10;
      return px;
    }
  }, {
    key: "renderNavItems",
...
//# sourceMappingURL=settings.js.6401e5295ee1ef127d8c.hot-update.js.map