...
})(["background:purple;display:grid;grid-template-columns:repeat(7,1fr);grid-gap:5px;min-width:800px;margin-top:20px;margin-left:50%;transform:translateX(-50%);text-align:center;background:#000;justify-content:space-around;a{color:white;}"]);
...
})(["background:green;border:1px solid red;margin-top:30px;width:100%;height:40px;"]);
...
//# sourceMappingURL=settings.js.6e523ae0f841ed237e34.hot-update.js.map