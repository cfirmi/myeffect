...
})(["display:grid;grid-template-columns:repeat(7,1fr);grid-gap:5px;min-width:800px;margin-top:20px;margin-left:50%;transform:translateX(-50%);text-align:center;justify-content:space-around;border-radius:10px 5px 3px 20px;a{color:white;}"]);
...
})(["margin-top:30px;width:100%;height:40px;"]);
...
//# sourceMappingURL=settings.js.bad09d441be8747c6993.hot-update.js.map