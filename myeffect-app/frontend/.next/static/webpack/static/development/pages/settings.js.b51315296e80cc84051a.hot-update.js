...
})(["display:grid;grid-template-columns:repeat(7,1fr);grid-gap:20px;min-width:800px;margin-top:20px;margin-left:50%;transform:translateX(-50%);text-align:center;justify-content:space-around;background:#000;border-radius:10px 5px 3px 20px;a{color:white;}"]);
...
//# sourceMappingURL=settings.js.b51315296e80cc84051a.hot-update.js.map