...
export default class challengescards extends Component {
  static defaultProps = {
    challenges: [
      ...
      { id: uuid(), points: '1047', name: 'MyEffect Challenge', host: 'Kelly Lovell', desc: 'Promote and tech code!', icon: '../../../static/images/profile/challenges/icon/LifeAction.svg'},
      ...
      { id: uuid(), points: '397', host: 'Tom Tiddles', desc: 'Organize groups and collect as many canned and dry items to help support people affected by Huricane Tim!', icon: '../../../static/images/profile/challenges/icon/ClimateAction.svg'},
    ]
  }
  render() {
    return (
